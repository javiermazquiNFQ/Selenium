...
public class AvivaHomeTest extends AvivaTest{
    ...
    @Test
    public void searchAviva() throws InterruptedException{
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Grupo Aviva - compañía de seguros líder en Europa, el mayor grupo ...")));
